...
export const article = {
  author: 'Will Johnson',
  date: '2022-03-22',
  title: 'NFTs: Exploring the Fragmented Data Landscape Behind the JPEGs',
  link: 'https://mirror.xyz/atomicform.eth/KejhjmPE_qqUNsRQ3rh6mrx_kuPNvID944Qy1JhSRS4',
  description:
    'An Analysis of the state and challenges of NFT Metadata',
}
